  ...
  return (
    <div className="card">
      <div className="flex justify-between items-start mb-4">
        ...
        <span className={`px-3 py-1 rounded-full text-xs font-medium border ${alertStyles[region.alertLevel]}`}>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="bg-bg-secondary rounded-lg p-3 text-center">
          <div className="text-xs text-text-muted mb-1">Temperatura</div>
          <div className="text-xl font-bold text-text-primary">{region.temperature}°C</div>
        </div>
        <div className="bg-bg-secondary rounded-lg p-3 text-center">
          <div className="text-xs text-text-muted mb-1">Umidade</div>
          <div className="text-xl font-bold text-text-primary">{region.humidity}%</div>
        </div>
        <div className="bg-bg-secondary rounded-lg p-3 text-center">
          <div className="text-xs text-text-muted mb-1">Qualidade do Ar</div>
